...
import 'package:book_app/e_book_features/data/datasources/commit_data_source/commit_remote_data_source.dart';
...
class _SpalshPageState extends State<SpalshPage> {
  ...
  void initState() {
    ...
    Timer(Duration(seconds: splashDelay), () async {
      try {
        UserModel c =
            await UserLocalDataSourceImpl(sharedPreferences: sl()).getUser();
